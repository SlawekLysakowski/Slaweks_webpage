let korean = ['미리','부지런하다','아끼다','즐기다','차례대로','글자','음감','뛰어나다','사교젹이다','손재주가 좋다',
...
let polish = ['przed czasem, wcześniej','ciężko pracować','oszczędzać','bawić się, cieszyć się','po kolei','litery','zmysł słuchu',
    ...
    'Absolwent','Znajdź pracę','wreszcie','Praca','klasa','osobowość','moje oczy są przyćmione','ból gardła','sztywna szyja',
    'sztywny kark','spragniony','czuć się zdenerwowanym, mieć wzdęty brzuch','ciężko na sercu','zablokowany','spuchnąć',
    ...
    'przejedzenie','Nadmierne picie','Nadmierna prędkość','nadmierne wydatki','zysk','z łatwością, powoli','Praca dyplomowa',
    'praca naukowa','smutny','zerwać, rozstać się, oddalić się','Sztuka','długo','wszyscy(bez względu na wiek i płeć)','tofu',
    ...
    'Charakterystyka','funkcja ','rozmowa kwalifikacyjna, wywiad','spaść, opuścić coś, padać','ciężki, bolesny, ','cicho, spokojnie',
    'dyskretnie','porzucenie, zaniechanie','ukochany(a), sympatia','spotkanie','być otwartym','festyn, święto',
    'rada, sugestia, podpowiedź','zawsze, zwykle','przeszkadzać, blokować','na pewno, niewątpliwie','liceum',
    ['absolwent', '(absolwent tej samej uczelni)'],'pokazywanie palcem','wymieniać','wskazać','materiał, składnik','oczywiście',
    'Złościć się','bezpośrednio','oczywisty, znany','wściec się','zmiana, fluktuacja','towar niskiej jakości',
    'ściągać opuszczać, zmniejszać','ostatnio, parę dni temu','nadzieja','oferta, wycena',
];
let english = ['already','Be diligent','economising, saving','enjoy','In turn, in order','letters','hearing sense','outstanding',
