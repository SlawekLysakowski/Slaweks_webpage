...
})({"gK5Pa":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "abb8b146858b8055";
...
},{}],"ikapx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "showVocab", ()=>showVocab
);
var _vocabularyJs = require("./vocabulary.js");
var _vocabularyJsDefault = parcelHelpers.interopDefault(_vocabularyJs);
const showVocab = function() {
    _vocabularyJsDefault.default.forEach((word, i)=>{
        console.log(word, i);
        let markup = `
     <div id="id">
     <p > ${_vocabularyJsDefault.default.length - i}</td></p>
    </div>

    <div id="jap-vocab">
     <p > ${_vocabularyJsDefault.default[_vocabularyJsDefault.default.length - i - 1]}</p>
    </div>
      <div id="kor-vocab">
     <p > ${_vocabularyJs.koreanWords[_vocabularyJsDefault.default.length - i - 1]}</p>
    </div>
     <div id="eng-vocab">
     <p > ${_vocabularyJs.englishWords[_vocabularyJsDefault.default.length - i - 1]}</p>
    </div>
     <div id="pol-vocab">
     <p > ${_vocabularyJs.polishWords[_vocabularyJsDefault.default.length - i - 1]}</p>
    </div>
...
},{"./vocabulary.js":"gTAhr","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gTAhr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}]},["gK5Pa","ikapx"], "ikapx", "parcelRequire99e3")

//# sourceMappingURL=vocabList.858b8055.js.map
